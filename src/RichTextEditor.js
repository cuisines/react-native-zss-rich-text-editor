...
import {Alert,Modal, View, Text, StyleSheet, TextInput, TouchableOpacity, Platform, PixelRatio, Keyboard, Dimensions} from 'react-native';
...
export default class RichTextEditor extends Component {
  ...
  setEditorAvailableHeightBasedOnKeyboardHeight(keyboardHeight) {
    const {top = 0, bottom = 140} = this.props.contentInset;
    ...
    return (
      <View style={[{alignSelf: 'stretch', flexDirection: 'row'}, containerPlatformStyle]}>
        ...
        <TouchableOpacity
            onPress={() => {
              if (this._linkIsNew()) {
                this.validateUrl(this.state.linkUrl)
